            ...
            <Grid item xs={6}>
                <Stack spacing={2} direction={"row"} justifyContent="center" alignItems="center">
                    ...
                    <TextField
                        ...
                        name="rescued"
                        value={rescued}
                        onChange={(event) => {setRescued(parseInt(event.target.value))}}
                     />
                </Stack>
            </Grid>
            <Grid item xs={6}>
                <Stack spacing={2} direction={"row"} justifyContent="center" alignItems="center">
                    ...
                    <TextField
                        ...
                        name="medicalized"
                        value={medicalized}
                        onChange={(event) => {setMedicalized(parseInt(event.target.value))}}
                    />
                </Stack>
            </Grid>
            <Grid item xs={6}>
                <Stack spacing={2} direction={"row"} justifyContent="center" alignItems="center">
                    ...
                    <TextField
                        ...
                        name="deceased"
                        value={deceased}
                        onChange={(event) => {setDeceased(parseInt(event.target.value))}}
                    />
                </Stack>
            </Grid>
            <Grid item xs={6}>
                <Stack spacing={2} direction={"row"} justifyContent="center" alignItems="center">
                    ...
                    <TextField
                        ...
                        onChange={(event) => {setBoatRegistration(event.target.value)}}
                    />
                </Stack>
            </Grid>
        </Grid>
